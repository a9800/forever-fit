   ...
   renderDrop: function(){ 
      ...
      this.selected.forEach(function(select, index){ 
         ...
         var childCloseHTML = $.template(
            '<i onclick="removeGoal(this.parentNode)" class="material-icons btnclose" data-index="'+select.index+'">&#xe5c9;</i></span>')
   ...
   renderOptions: function(){  
      ...
      this.options.forEach(function(option, index){
         var childHTML = $.template(
            '<a data-index="'+index+'" onclick="addGoal(this)" class="'+option.state+'">'+ option.html +'</a>')
